	...
	<div class="content trans" style="width: 100%; height: 100%;">
		...
		<div class="container doclist content trans2"
			...
			<div class="row" style="background-color: white; margin: 0 auto;">
				...
				<s:property value="%{fname + ' ' + 'lname'}" />
				<s:property value="dsb.date" />
				@<s:property value="dsb.time" />
				is now
				<s:property value="dsb.status" />
				<br>
			</div>
					<a href="doclistsched">click here to go back</a> <br>
			<br>
		</div>
		<br>
	</div>
