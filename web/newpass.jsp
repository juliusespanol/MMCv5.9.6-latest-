	...
	<div class="content trans" style="width: 100%">
		...
		<div class="container queue content trans2"
			...
			<div class="row" style="margin: 0 auto;">
				...
				<div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
					<h3>NEW PASSWORD:</h3>
					<ver:form action="newpass" method="post">
						<table>
							<tbody>
								<tr>
									<td>
									<ver:password
											label="PASSWORD " key="pass1" id="labels"
											style="width: 250px; height: 30px; font-size: 18px; margin: 0;" />
									<ver:password
											label="ENTER PASSWORD AGAIN " key="pass2" id="labels"
								...
								<tr>
									<td colspan="2"><ver:submit cssClass="button-search" value="RESET PASSWORD"
								...
								<tr>
									<td colspan="2">
										<ver:reset cssClass="button-search" value="RESET"
											style="width: 250px; font-size: 18px;" />
									</td>
								</tr>
							</tbody>
