...
<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top navtrans">
	...
	<div id="myNav" class="overlay">
		...
		<ver:form action="changepassworddoctor" method="post">
	...
	<div class="container doclist content trans2">
		<div class="row">
			...
			<div class="col-md-2 col-xs-2 col-sm-2 col-lg-2"
				...
				<h4><font style="color: BLACK;">NAME: </font>
					</h4>
				<h4><font style="color: BLACK;">USERNAME: </font></h4>
				<h4><font style="color: BLACK;">GENDER: </font></h4>
				<h4><font style="color: BLACK;">ADDRESS: </font></h4>
				<h4><font style="color: BLACK;">BIRTHDATE: </font></h4>
				<h4><font style="color: BLACK;">SPECIALIZATION: </font></h4>
				<br>
				<br>
			</div>
			<div class="col-md-6 col-xs-6 col-sm-6 col-lg-6" style="text-align: left">
			<h4 style="text-transform: uppercase;">:
				<s:property value="doc.fname"/> <s:property value="doc.lname"/></h4>
			<h4>:<s:property value="doc.username"/></h4>
			<h4>:<s:property value="doc.sex"/></h4>
			<h4>:<s:property value="doc.address"/></h4>
			<h4>:<s:property value="doc.birthdate"/></h4>
			<h4>:<s:property value="doc.specialization"/></h4>
			</div>
		</div>
		<br>
