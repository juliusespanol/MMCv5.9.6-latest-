...
<body>
	...
	<div class="content trans">
		...
		<div class="row dnsContainer content"
			...
			<s:form action="weeklydatenurse" method="post">
				<p>
					Choose Another Date:
								...
								<td><s:div>
										<s:if test="%{Status=='available'}">
											<s:form id="" method="post">
												...
												<s:submit value="reserve" action="reservenurse"
										...
										<s:elseif test="%{Status=='reserved'}">
											<s:form id="" action="reserve" method="post">
												...
												<s:if test="%{patientNum==#session['patient']}">
										This patient's reservation
										<s:submit value="cancel" action="cancelnurse"
														style="height: 30px;width: 150px;" />
			...
			<br>
			<a class="button-nav" href="nursehome.jsp" style="font-size: 16px;color:black;">Back
				</a>
		</div>
		<br>
	</div>
