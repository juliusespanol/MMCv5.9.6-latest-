...
public class PatientRegisterAction extends ActionSupport
	...
	private PatientRegisterBean prb = new PatientRegisterBean();
	...
	prb.setUsername(username);
	prb.setFname(fname);
	prb.setLname(lname);
	prb.setAddress(address);
	prb.setBirthdate(birthdate);
	prb.setSex(sex);
	//hiwalay sila
	use.setUsername(username);
	use.setPassword(password);
	use.setUserType("PATIENT");
	use.setVercode(code);
	use.setEmail(email);
